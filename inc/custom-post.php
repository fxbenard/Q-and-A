...
function create_qa_post_types() {
	 ...
	 $labels = array(
		'name'				=> _x( 'FAQ Categories', 'taxonomy general name', 'qa-free'),
		'singular_name'		=> _x( 'FAQ Category', 'taxonomy singular name', 'qa-free' ),
  	...
  	register_post_type( 'qa_faqs',
		array(
			...
			'menu_icon' 			=> Q_A_PLUS_PLUGIN_URL . 'admin/img/question-frame-16.png'	
		)
	); 	
