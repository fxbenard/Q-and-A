...
if ( ! $page_exists && $qaplus_admin['dismiss_slug'] != "true" ) {
	$qaplus_errors[] = 'The FAQ homepage "' . $qaplus_options['faq_slug'] . '" doesn\'t exist yet. Would you like to create it?<br /><br />
...
?>
	...
	<div id="tabs">
		<ul>
			...
			<li><a id="tab-anchor-2" class="tab-anchor" href="#tabs-2">Documentation</a></li>
		</ul>
	...
	<p>You're using Q &amp; A Plus, made by <a href="http://madebyraygun.com">Raygun</a>. Check out our <a href="http://madebyraygun.com/wordpress/" target="_blank">other plugins</a>, and if you have any problems, stop by our <a href="http://madebyraygun.com/support/" target="_blank">support forum</a>!</p>
</div>
...
function q_a_plus_admin_init(){
	...
	add_settings_field(
		'q_a_plus_slug',
		__( 'FAQ homepage <span class="vtip" title="Where would you like your FAQ homepage to live? This can be a page that already exists on your site, but it shouldn\'t be the front page.">?</span>', 'qa_plus' ),
		'q_a_plus_slug_input',
		'q_a_plus',
		'q_a_plus_homepage_settings'
	);
	...
	add_settings_field(
		'q_a_plus_limit',
		__( 'FAQs per category <span class="vtip" title="How many items should we show in each category on the Q & A homepage? -1 shows all FAQ entries. Users will be able to click a link to see all questions on the category page.">?</span>', 'qa_plus' ),
	...
	add_settings_field(
		'q_a_plus_excerpts',
		__( 'Show excerpts <span class="vtip" title="Show excerpts instead of full entries on the FAQ homepage.">?</span>', 'qa_plus' ),
	...
	add_settings_field(
		'q_a_plus_search',
		__( 'Show search <span class="vtip" title="Show the search form on the home and category pages.">?</span>', 'qa_plus' ),
	...
	add_settings_field(
		...
		__( 'Search box position <span class="vtip" title="Add the search box before or after the FAQ content.">?</span>', 'qa_plus' ),
	...
	add_settings_field(
		...
		__( 'Show permalinks <span class="vtip" title="Add a permalink to each FAQ entry">?</span>', 'qa_plus' ),
	...
	add_settings_field(
		...
		__( 'Animation style <span class="vtip" title="What animation should be used to show/hide the FAQs?">?</span>', 'qa_plus' ),
	...
	add_settings_field(
		'q_a_plus_accordion',
		__( 'Accordion behavior <span class="vtip" title="Clicking a FAQ title closes any other open FAQs.">?</span>', 'qa_plus' ),
	...
	add_settings_field(
		...
		__( 'Enable show/hide behavior <span class="vtip" title="Uncheck this to turn off the show/hide behavior.">?</span>', 'qa_plus' ),
	...
	add_settings_field(
		'q_a_plus_jquery',
		__( 'jQuery version <span class="vtip" title="Which version of jQuery should the plugin use? This can sometimes help with compatibility issues. You should leave this set to <em>WP Included</em> unless you have a specific reason to change it.">?</span>', 'qa_plus' ),
...
function q_a_plus_search_position_input() {
	...
	<select name="qaplus_options[searchpos]" value="<?php echo $qaplus_options[searchpos]; ?>" />
		<option value="top" <?php if ( $qaplus_options['searchpos'] == "top" ) echo " selected='selected'";?>><?php _e( 'Top', 'qa_plus');?></option>
		<option value="bottom" <?php if ( $qaplus_options['searchpos'] == "bottom" ) echo " selected='selected'";?>><?php _e( 'Bottom', 'qa_plus');?></option>
	</select>
<?php }
...
function q_a_plus_animation_style_input() {
	...
	<select name="qaplus_options[animation]" value="<?php echo $qaplus_options[animation]; ?>" />
		<option value="fade" <?php if ( $qaplus_options['animation'] == "fade" ) echo " selected='selected'";?>><?php _e( 'Fade', 'qa_plus');?></option>
		<option value="slide" <?php if ( $qaplus_options['animation'] == "slide" ) echo " selected='selected'";?>><?php _e( 'Reveal', 'qa_plus');?></option>
		<option value="none" <?php if ( $qaplus_options['animation'] == "none" ) echo " selected='selected'";?>><?php _e( 'None', 'qa_plus');?></option>
	</select>
<?php }
...
function q_a_plus_jquery_input() {
	...
	<select name="qaplus_options[jquery]" value="<?php echo $qaplus_options[jquery]; ?>" />
		<option value="wp" <?php if ( $qaplus_options['jquery'] == "wp" ) echo " selected='selected'";?>><?php _e( 'WP included', 'qa_plus');?></option>
		<option value="force" <?php if ( $qaplus_options['jquery'] == "force" ) echo " selected='selected'";?>><?php _e( 'Force latest version', 'qa_plus');?></option>
		<option value="none" <?php if ( $qaplus_options['jquery'] == "none" ) echo " selected='selected'";?>><?php _e( 'None', 'qa_plus');?></option>
	</select>
<?php }
